...
(/** @lends <global> */function( $ ) {
	...
	DataTable.models.oSettings = {
		...
		/**
		 * includes which are called prior to sending an Ajax request so extra
	...
	DataTable.ext = _ext = {
		...
		type: {
			 ...
			 *
			 * `{type}-pre`: includes defined take a single parameter:
			 *
			 ...
			 *
			 * `{type}-asc` and `{type}-desc`: includes are typical Javascript sort
